...
{
    public partial class EditCatagory : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contacts_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contacts_AspNetUsers_LastUpdatedById",
                        column: x => x.LastUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessagePrivacy = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Messages_AspNetUsers_LastUpdatedById",
                        column: x => x.LastUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Docements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Docements_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Docements_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Docements_AspNetUsers_LastUpdatedById",
                        column: x => x.LastUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Docements_Messages_MessageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessagesCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MessagesCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessagesCategories_Messages_MessageId",
                        column: x => x.MessageId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdatedOn = table.Column<DateTime>(nullable: true),
                    MessageId = table.Column<Guid>(nullable: false),
                    RecipintId = table.Column<string>(nullable: true),
                    IsReaded = table.Column<bool>(nullable: false),
                    IsReplyed = table.Column<bool>(nullable: false),
                    IsIgnore = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Packages_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Packages_AspNetUsers_LastUpdatedById",
                        column: x => x.LastUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Packages_Messages_MessageId",
                        column: x => x.MessageId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Packages_AspNetUsers_RecipintId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_LastUpdatedById",
                table: "Contacts",
                column: "LastUpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Docements_CreatedById",
                table: "Docements",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Docements_DeletedById",
                table: "Docements",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_Docements_LastUpdatedById",
                table: "Docements",
                column: "LastUpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Docements_MessageId",
                table: "Docements",
                column: "MessageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_LastUpdatedById",
                table: "Messages",
                column: "LastUpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessagesCategories_CategoryId",
                table: "MessagesCategories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_MessagesCategories_MessageId",
                table: "MessagesCategories",
                column: "MessageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Packages_DeletedById",
                table: "Packages",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_Packages_LastUpdatedById",
                table: "Packages",
                column: "LastUpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Packages_MessageId",
                table: "Packages",
                column: "MessageId");

            migrationBuilder.CreateIndex(
                name: "IX_Packages_RecipintId",
                table: "Packages",
                column: "RecipintId");
        }
